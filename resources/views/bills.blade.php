                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-success btn-sm payment" value="{{ $transaction->receipt_no }}" data-bs-toggle="modal" data-bs-target="#comfirm-delete" role="button">Pay</button>
                                    </div>
                                </td>
                            </tr> 
                        @empty
        ...
        <script>
            ...
            // Table filter
                ...
                $(document).on('click', '.payment', function(){
                    $('.modal-title').text('Payment Confirmation');
                    
                    var receipt_no=$(this).val();
                    $.get('payment-modal/bill_payment/'+receipt_no, function(result) {
