                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('payments') ? 'active' : '' }}" href="{{ route('payments') }}">{{ __('Payments') }}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('payment_list') ? 'active' : '' }}" href="{{ route('payment_list') }}">{{ __('Paid List') }}</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    @if (Auth::user()->user_level === 'Accountant')
                                        <a class="dropdown-item" href="{{ route('users') }}">
                                            {{ __('Users') }}
                                        </a>
                                    @endif
